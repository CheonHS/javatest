...
public class Ex14_11 {
	public static void main(String[] args) {
		Student3[] stuArr = {
				...
				new Student3("강자미", false, 2, 3, 150),
		...
		Map<Integer, Map<Integer, Student3>> topStuByHakAndBan = Stream.of(stuArr)
				.collect(groupingBy(Student3::getHak, groupingBy(Student3::getBan, collectingAndThen(
		...
		System.out.printf("%n6. 다중그룹화 + 통계(학년별, 판별 성적그룹)%n");
